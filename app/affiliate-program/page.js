                  ...
                  <div className="content-box ml_70">
                    ...
                    <div className="inner-box">
                      <div className="single-item">
                        ...
                        <h3><Link href="/index-2">Register as an Affiliate</Link></h3>
                      ...
                      <div className="single-item">
                        ...
                        <h3><Link href="/index-2">Get Your Unique Tracking Links</Link></h3>
                      ...
                      <div className="single-item">
                        ...
                        <h3><Link href="/index-2">Start Promoting AUT Investments LTD</Link></h3>
                      ...
                      <div className="single-item">
                        ...
                        <h3><Link href="/index-2">Track Referrals and Earnings</Link></h3>
                      ...
                      <div className="single-item">
                        ...
                        <h3><Link href="/index-2"> Receive Timely Payouts</Link></h3>
