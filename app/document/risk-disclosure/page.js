                    ...
                    <div className="auto-container">
                        ...
                        <div className="row clearfix row-deck">
                            <div className="col-lg-3 col-md-6 col-sm-12 account-block">
                                ...
                                <div className="inner-box">
                                    <div className="icon-box"><i className="fa fa-money-bill-trend-up fw-lighter"></i></div>
                                    ...
                                    <div className="row align-items-center">
                                                    ...
                                                    <div className="education-details-content">
                                                        <div class="text-box">
                                                            <ul class="list-item clearfix">
                                                                <li class="lh-md">
                                                                    <b class="fs-6 text-dark">Platform Downtime:</b> <br></br>Technology failures, internet disruptions, or server outages can limit access to the platform and prevent order placement or execution.
                                                                </li>
                                                                <li class="lh-md">
                                                                    <b class="fs-6 text-dark">Third-Party Risks:</b> <br></br>
                                                                ...
                                                                <li class="lh-md">
                                                                    <b class="fs-6 text-dark">Execution Delays:</b> <br></br>
                                        ...
                                        <div className="col-lg-6 col-md-12 col-sm-12 image-column">
                                            <div className="image-box">
                                                <img src="/assets/images/resource/risk.jpg" className="rounded" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="auto-container">
                        <div className="inner-container">
                            ...
                            <div className="row align-items-center">
                                ...
                                <div className="text-box">
                                    <h2 className="text-dark fw-bold">Trade Responsibly. Stay Informed.</h2>
                                    <p className="text-light fs-5 mt_30">Understanding risk is the first step toward successful trading. At AUT Investments LTD, we’re committed to transparency, control, and equipping you with everything you need to navigate the markets responsibly.</p>
