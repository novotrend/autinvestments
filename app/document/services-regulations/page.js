                            ...
                            <div className="row align-items-center">
                                <div className="col-12 text-column">
                                    <div className="text-box">
                                        ...
                                        <p className="text-light fs-5 mt_30">This Services Regulations document is binding from the date above and applies to all clients using the <br></ br> services of AUT Investments LTD.</p>
