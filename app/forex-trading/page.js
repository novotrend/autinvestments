    ...
    <div className="boxed_wrapper">
      <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Forex Trading">
        ...
        <section className="apps-style-two pt_150 pb_150">
          ...
          <div className="auto-container">
            <div className="row align-items-center">
              <div className="col-xl-6 col-md-12 col-sm-12 content-column">
                <div className="content_block_four">
                  <div className="content-box ml_80 w-100">
                    ...
                    <div className="d-flex flex-sm-row flex-column align-items-sm-center gap-3">
                      <Link href="/index-2" className="theme-btn btn-one bg-dark btn-sm">
                        Open Live Account
                      </Link>
                      <Link href="/index-2" className="theme-btn btn-one bg-dark btn-sm">
                        Try a Demo
