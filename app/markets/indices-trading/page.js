          ...
          <div className="auto-container">
            <div className="row align-items-center">
                ...
                <section className="funfact-section">
                  <div className="auto-container px-0">
                    <div className="inner-container d-flex flex-column p-5 aligh-items-start justify-content-start">
                      ...
                      <p>Indices represent the performance of a group of selected stocks from a particular market or
                          sector. Trading index CFDs allows you to speculate on the movement of entire markets like the
                          US 30 (Dow Jones), GER 40 (DAX), or UK 100 (FTSE) without owning the underlying assets.</p>
                      <p>
              ...
              <div className="col-md-4">
                <img src="../assets/images/resource/indices-1.jpg" alt="" className="rounded"/>
              </div>
            </div>
          ...
          <div className="auto-container">
            ...
            <div className="row clearfix row-deck">
              <div className="col-lg-4 col-md-6 col-sm-12 markets-block">
                <div className="markets-block-one text-start">
        ...
        <section className="trading-style-four pt_100 pb_100">
          <div className="auto-container">
            ...
            <div className="tabs-box">
              <ul className="tab-btns tab-buttons clearfix border-bottom">
        ...
        <section className="markets-section pt_60 pb_70">
          <div className="auto-container">
            <div className="row align-items-center">
              ...
              <div className="col-md-4">
                <img src="../assets/images/resource/indices-2.jpg" alt="" className="rounded"/>
              </div>
            </div>
          </div>
        </section>
