                  ...
                  <div className="content-box ml_70">
                    ...
                    <div className="inner-box">
                      ...
                      <div className="single-item">
                        ...
                        <h3><Link href="/index-2">Place Your First Trade</Link></h3>
                        <p>Use market or limit orders</p>
                      </div>
                      <div className="single-item">
                        <span className="count-text bg-light text-dark">6</span>
                        <h3><Link href="/index-2">Learn & Optimize</Link></h3>
              ...
              <div className="col-lg-6 col-md-12 col-sm-12 content-column">
                <div className="content_block_four">
                  <div className="content-box ml_80">
                    ...
                    <Link href="/index-2" className="theme-btn btn-one bg-dark me-3">
                      Open Live Account
                    </Link>
                    <Link href="/index-2" className="theme-btn btn-one bg-dark me-3">
                      Try a Demo
                    </Link>
                    <Link href="/index-2" className="theme-btn btn-one bg-dark">
                      Contact Support
                    </Link>
                  </div>
                </div>
