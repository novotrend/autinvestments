                        ...
                        <div className="col-lg-6 col-md-12 news-block d-flex flex-column">
                            <div className="news-block-one w-100 d-flex flex-column h-100 wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                ...
                                <div className="author-box mt-auto">
                                    <Link href='/' className="theme-btn btn-one">Learn About Our Compliance</Link>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-12 news-block d-flex flex-column">
                            <div className="news-block-one w-100 d-flex flex-column h-100 wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                ...
                                <div className="author-box mt-auto">
                                    <Link href='/' className="theme-btn btn-one">View Promotions</Link>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-12 news-block d-flex flex-column">
                            <div className="news-block-one w-100 d-flex flex-column h-100 wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                ...
                                <div className="author-box mt-auto">
                                    <Link href='/' className="theme-btn btn-one">Join Affiliate Program</Link>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-12 news-block d-flex flex-column">
                            <div className="news-block-one w-100 d-flex flex-column h-100 wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                ...
                                <div className="author-box mt-auto">
                                    <Link href='/' className="theme-btn btn-one">Contact Support</Link>
                                </div>
                            </div>
                        </div>
                    </div>
