                ...
                <div className="auto-container">
                    <div className="sec-title pt_60 pb_60">
                        ...
                        <div className="d-flex flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <Link href="/markets-details" className="theme-btn btn-one">Start Trading Now</Link>
                        </div>
                    </div>
                    <div className="inner-container clearfix">
                        <div className="trading-block-one">
                            <div className="inner-box">
                                ...
                                <h3><a href="markets-details.html">Copy Trading</a></h3>
                        ...
                        <div className="trading-block-one">
                            <div className="inner-box">
                                ...
                                <h3><a href="markets-details.html">Social Trading</a></h3>
                        ...
                        <div className="trading-block-one">
                            <div className="inner-box">
                                ...
                                <h3><a href="markets-details.html">Algo Trading</a></h3>
                        ...
                        <div className="trading-block-one">
                            <div className="inner-box">
                                ...
                                <h3><a href="markets-details.html">Economic Calendar</a></h3>
                        ...
                        <div className="trading-block-one">
                            <div className="inner-box">
                                ...
                                <h3><a href="markets-details.html">Daily Market Analysis</a></h3>
                        ...
                        <div className="trading-block-one">
                            <div className="inner-box">
                                ...
                                <h3><a href="markets-details.html">VPS Hosting</a></h3>
